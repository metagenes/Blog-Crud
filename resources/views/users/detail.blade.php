@extends('layouts.app', ['activePage' => 'Detail User', 'titlePage' => __('Detail User')])
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="" value="{{ $user->name }}" readonly />
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('urlinquiry') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" id="input-email" type="email" placeholder="" value="{{ $user->email }}" readonly />
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('urlcallback') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('urlcallback') ? ' is-invalid' : '' }}" name="phone" id="input-phone" type="phone" placeholder="" value="{{ $user->phone_number }}" readonly />
                    </div>
                  </div>
                </div>
