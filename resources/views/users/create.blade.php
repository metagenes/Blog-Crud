          ...
          <form method="post" action="{{ route('user.store') }}" class="form-horizontal">
            ...
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('User Name') }}" value="" required="true" aria-required="true"/>
                    </div>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('urlcallback') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('urlcallback') ? ' is-invalid' : '' }}" name="phone" id="input-phone" type="phone" placeholder="{{ __('Phone') }}" value="" required />
                    </div>
                  </div>
                </div>
                ...
                <!-- repeat password -->
                <div class="row">
                  <label class="col-sm-2 col-form-label">{{ __('Repeat Password') }}</label>
                  <div class="col-sm-7">
